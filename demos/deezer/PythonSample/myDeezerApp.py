...
class MyDeezerApp(object):
    ...
    def __init__(self, debug_mode=False):
        ...
        # Identifiers
        self.user_access_token = u"frbLjlQSJl8fYix1vQxESAIUPTq9JxUSi87SAtl58l10nbAsg2"  # SET your user access token
        self.your_application_id = u"215704"  # SET your application id
        self.your_application_name = u"BusStationDemo"  # SET your application name
