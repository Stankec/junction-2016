...
#define USER_ACCESS_TOKEN        "frbLjlQSJl8fYix1vQxESAIUPTq9JxUSi87SAtl58l10nbAsg2" // Sample access token corresponding to a free user account, to be replaced by yours.
#define YOUR_APPLICATION_ID      "215704"     // SET YOUR APPLICATION ID
#define YOUR_APPLICATION_NAME    "BusStationDemo" // SET YOUR APPLICATION NAME
